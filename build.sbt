...
val `scala3-library` = Build.`scala3-library`.disablePlugins(UnusedCodePlugin)
val `scala3-library-bootstrapped` = Build.`scala3-library-bootstrapped`.disablePlugins(UnusedCodePlugin)
val `scala3-library-bootstrappedJS` = Build.`scala3-library-bootstrappedJS`.disablePlugins(UnusedCodePlugin)
...
val `stdlib-bootstrapped` = Build.`stdlib-bootstrapped`.disablePlugins(UnusedCodePlugin)
...
val sjsJUnitTests = Build.sjsJUnitTests.disablePlugins(UnusedCodePlugin)
